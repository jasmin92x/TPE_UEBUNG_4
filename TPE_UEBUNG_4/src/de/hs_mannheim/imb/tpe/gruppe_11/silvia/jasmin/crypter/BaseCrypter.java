 ...
 *
 */
public abstract class BaseCrypter implements Crypter {
	 ...
	 */
	BaseCrypter(String key) throws IllegalKeyException {
		validateKey(key);
		this.key = key;
	}
	...
	public String encrypt(String text) {
		...
		for (int i = 0; i < text.length(); ++i) {
			try {
				 ...
				 */
				System.out.println("Illegal character '" + text.charAt(i) + "'");
			}
		}
		return sb.toString();
	}
